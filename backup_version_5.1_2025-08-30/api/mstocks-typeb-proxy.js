// Consolidated MStocks TypeB API Proxy
// Handles all TypeB endpoints to reduce serverless function count for Vercel Hobby plan
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const baseUrl = 'https://api.mstock.trade/openapi/typeb';
    const targetUrl = `${baseUrl}/${apiPath}`;
    
    console.log('Proxying TypeB request:', {
      method: req.method,
      apiPath,
      targetUrl,
      headers: {
