...
console.log('Final Fix for Sold Items - Correcting Profit Values');
console.log('==================================================');
...
const jsContent = `// Auto-generated sold items data from CSV with corrected profit values
...
// Let me also check if we need to manually adjust some values
console.log('\nTop 10 profit items:');
soldItems
  .sort((a, b) => b.profit - a.profit)
  .slice(0, 10)
  .forEach((item, index) => {
    console.log(`${index + 1}. ${item.symbol} - Profit: ${item.profit}`);
  }); 